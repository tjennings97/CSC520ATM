...
public class JPanelWithdrawConfirmation extends JPanel implements ActionListener
{
    ...
    */
	 ...
	 */
	public JPanelWithdrawConfirmation(JFrameATM atmFrame) {
		...
		lblTitle = new JLabel("Withdraw complete. ");
